...
parser.add_option("--data", dest="data_raw", help="the directory of training dataset", default=None, type="string")
parser.add_option("--save", dest="cubes", help="the directory of processed 3D cubes", default=None, type="string")
